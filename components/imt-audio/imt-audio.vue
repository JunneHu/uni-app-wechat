<template>
	<view class="imt-audio">
		<image :src="img" :class="paused ? 'img':'img rotate'" v-if="img"></image>
		...
		<view class="audio-control-wrapper" :style="{color}">
			...
			<view class="audio-control audio-control-switch" :style="{borderColor:color}" @click="audio.paused ? play() : audio.pause()">{{paused?'&#xe865;':'&#xe612;'}}</view>
